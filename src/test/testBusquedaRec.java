...
public class testBusquedaRec {
	...
	public static void main(String[] args) {
		Arbol<IPersona> arbol = new Arbol<>(); // ✅ uso de genéricos
		Comparator<IPersona> cmp = new ComparadorPorDNI(); // ✅ comparador actualizado
		...
		INodo<IPersona> encontrado = arbol.buscar(p5, cmp); // ✅ uso correcto de genéricos
